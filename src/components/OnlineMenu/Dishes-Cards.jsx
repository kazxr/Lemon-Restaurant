...
function Card({ data }) {
  return (
    <>
      <div
        id={"card" + data.id}
        className="xl:w-[320px] lg:w-[300px]  md:w-[290px]   sm:w-[230px] 
        
            my-5 mx-2 pb-4 rounded-md bg-graySecondary  hover:ring-2 hover:ring-orangeSecondary  "
      >
        <img
          src={data.image}
          alt=""
        ...
        <p className="text-greenPrimary px-3 my-6 card-text h-[40px]">
          {data.description}
        </p>
